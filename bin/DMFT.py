...
class DMFTLauncher:
    """DMFTwDFT Initialization and Calculation (Python 3 version).
        ...
        if self.dft is not None and self.structurename is not None:
            ...
            if self.type == "HF":
                cmd = (
                    ...
                    + " && "
                    + python_command(
                        "RUNDMFT.py", "-hf", "-dft", self.dft, "-aiida", self.aiida
                    )
                )
            else:
                cmd = (
                    ...
                    + " && "
                    + python_command(
                        "RUNDMFT.py", "-dft", self.dft, "-aiida", self.aiida
                    )
                )
