...
We acknowledge Professor Kristjan Haule and Rutgers University for the CTQMC impurity solver and max-entropy routines used in DMFTwDFT. Please cite the relevant articles found on his website. We thank Professor Javier Junquera for his support with the full charge self-consistent DFT+DMFT implementation in SIESTA.
