...
The current directory is useful as prepared QE/AiiDA reference material, but it is not a complete launch directory for `DMFT.py -aiida` as committed.
...
The `DMFT.py -aiida` path copies the AiiDA/Wannier files to the standard DMFTwDFT names:
