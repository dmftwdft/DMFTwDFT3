...
if __name__=='__main__':
   trigger=str(input("Which deg. of fredom do you want from OUTCAR?\n (Please mind your whitespace and if mode is imaginary):"))
   count_me = int(input("How many atoms are there:"))
   bands=int(input("How many Bloch bands did you use:"))
   trig1='band No.'
#   bands= 60
   dof = 1
   xwt=0.
